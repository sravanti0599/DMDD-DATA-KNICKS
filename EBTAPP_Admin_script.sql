...
GRANT SELECT ON ARCHIVED_MERCHANTS_VIEW TO EBTMERCHANT, EBTADMIN;
...
GRANT SELECT ON REJECTED_TRANSACTIONS_VIEW TO EBTUSER,EBTMERCHANT, EBTADMIN;
GRANT SELECT ON MERCHANT_TRANSACTION_DETAILS_VIEW TO EBTMERCHANT, EBTADMIN;
